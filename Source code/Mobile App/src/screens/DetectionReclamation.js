...
export default class DetectionReclamation extends React.Component {
...
// Les fonctions de Detection : 
  ...
  toReclamationDetecter() {
    if( this.validerChamps() ) 
      this.props.navigation.navigate('ReclamationDetecter',{code:this.state.code}); 
    ...
    return (
      <View
        ...
        <View style={styles.viewTerminer} >
            <TouchableOpacity onPress={()=> this.toReclamationDetecter() }> 
